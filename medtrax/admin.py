...
class MedtraxAdminSite(AdminSite):
    site_header = format_html(
        '<span style="color: #667eea; font-weight: bold; font-size: 24px;">🏥 MEDTRAX Admin</span>'
    )
    site_title = 'MEDTRAX Admin Portal'
