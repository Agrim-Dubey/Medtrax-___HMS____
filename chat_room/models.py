...
class DoctorConnection(models.Model):
    ...
    from_doctor = models.ForeignKey(Doctor, on_delete=models.CASCADE, related_name='sent_requests')
    to_doctor = models.ForeignKey(Doctor, on_delete=models.CASCADE, related_name='received_requests')
